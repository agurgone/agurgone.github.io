---
title: "Enter the MATRIX model: a Multi-Agent model for Transition Risks with application to energy shocks"
collection: research
permalink: /research/WP4
excerpt: 'Journal article'
date: 2023-01-01
venue: 'Journal of Economic Dynamics and Control'
paperurl: 'https://doi.org/10.1016/j.jedc.2022.104589'
---
...
Ciola, E., Turco, E., Gurgone, A., Bazzana, D., Vergalli, S., & Menoncin, F. (2023). Enter the MATRIX model: a Multi-Agent model for Transition Risks with application to energy shocks. <i>Journal of Economic Dynamics and Control<i>, 146, 104589.